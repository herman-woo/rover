...
- [Y] The launch date, landing date, name and status along with any other information about the rover
- [Y] A selection bar for the user to choose which rover's information they want to see
...
- [Y] Provide a way to dynamically switch the UI to view one of the three rovers 
**This can be done using tabs, buttons, or any other UI control

To complete this project, your frontend code must:

- [Y] Use only pure functions
- [Y] Use at least one Higher Order Function
- [Y] Use the array method `map`
- [ ] Use the ImmutableJS library

To complete this project, your backend code must:

- [Y] Be built with Node/Express
- [Y] Make successful calls to the NASA API
- [Y] Use pure functions to do any logic necessary
- [Y] Hide any sensetive information from public view (In other words, use your dotenv file)
